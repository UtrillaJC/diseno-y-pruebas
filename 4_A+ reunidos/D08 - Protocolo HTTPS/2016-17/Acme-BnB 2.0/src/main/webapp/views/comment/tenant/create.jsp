...
<form:form action="comment/tenant/create.do" modelAttribute="commentTenant">
	...
	<acme:select items="${receiversTenant}" itemLabel="name" code="comment.receiver" path="receiver" />
