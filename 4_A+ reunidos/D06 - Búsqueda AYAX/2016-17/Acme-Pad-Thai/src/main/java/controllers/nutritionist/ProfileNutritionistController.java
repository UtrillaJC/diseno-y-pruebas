...
public class ProfileNutritionistController extends AbstractController {
	...
	public ProfileNutritionistController() {
		super();
	}
	...
	protected ModelAndView createEditModelAndView(Nutritionist nutritionist, String message) {
		...
		result = new ModelAndView("nutritionist/editProfile");
