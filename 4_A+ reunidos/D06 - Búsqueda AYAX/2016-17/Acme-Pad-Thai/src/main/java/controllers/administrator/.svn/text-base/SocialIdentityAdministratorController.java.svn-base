...
@Controller
@RequestMapping("/socialIdentity/administrator")
public class SocialIdentityAdministratorController extends AbstractController {
	...
	public SocialIdentityAdministratorController() {
		super();
	}
	...
	protected ModelAndView createEditModelAndView(Administrator administrator, String message) {
		...
		result = new ModelAndView("administrator/editSocialIdentity");
