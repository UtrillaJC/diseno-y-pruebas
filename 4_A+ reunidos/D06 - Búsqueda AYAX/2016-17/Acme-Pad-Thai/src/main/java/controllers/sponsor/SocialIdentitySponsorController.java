...
@Controller
@RequestMapping("/socialIdentity/sponsor")
public class SocialIdentitySponsorController extends AbstractController {
	...
	public SocialIdentitySponsorController() {
		super();
	}
	...
	protected ModelAndView createEditModelAndView(Sponsor sponsor, String message) {
		...
		result = new ModelAndView("sponsor/editSocialIdentity");
