...
<form:form action = "nutritionist/editProfile.do" modelAttribute = "nutritionist">
	...
	<legend>
		<spring:message code="nutritionist.informationData" />
	</legend>
		...
		<form:label path = "phoneNumber">
			<spring:message code = "nutritionist.phoneNumber" />:
		</form:label>
	...
	<jstl:choose>
		<jstl:when test="${nutritionist.socialIdentity == null}">
			<a href="socialIdentity/nutritionist/editSocialIdentity.do">
