...
<form:form action = "socialIdentity/administrator/editSocialIdentity.do" modelAttribute = "administrator">
	...
	<security:authorize access="isAuthenticated()">
		...
		<input type="button" name="cancel"
			...
			onclick="javascript: window.location.replace('administrator/editProfile.do')" />
	</security:authorize>
