...
<form:form action = "socialIdentity/nutritionist/editSocialIdentity.do" modelAttribute = "nutritionist">
	...
	<security:authorize access="isAuthenticated()">
		...
		<input type="button" name="cancel"
			...
			onclick="javascript: window.location.replace('nutritionist/editProfile.do')" />
	</security:authorize>
