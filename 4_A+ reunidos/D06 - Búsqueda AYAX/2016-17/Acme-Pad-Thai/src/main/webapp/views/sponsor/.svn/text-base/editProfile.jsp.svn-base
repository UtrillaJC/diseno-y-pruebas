...
<form:form action = "sponsor/editProfile.do" modelAttribute = "sponsor">
	...
	<legend>
		<spring:message code="sponsor.informationData" />
	</legend>
	...
	<jstl:choose>
		<jstl:when test="${sponsor.socialIdentity == null}">
			<a href="socialIdentity/sponsor/editSocialIdentity.do">
		...
		<jstl:when test="${sponsor.socialIdentity != null}">
			...
			<legend>
				<spring:message code="sponsor.socialIdentity" />
			</legend>
