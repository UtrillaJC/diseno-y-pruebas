...
<form:form action = "cook/editProfile.do" modelAttribute = "cook">
	...
	<legend>
		<spring:message code="cook.informationData" />
	</legend>
		...
		<form:label path = "phoneNumber">
			<spring:message code = "cook.phoneNumber" />:
		</form:label>
		...
		<form:label path = "address">
			<spring:message code = "cook.address" />:
		</form:label>
	...
	<jstl:choose>
		<jstl:when test="${cook.socialIdentity == null}">
			<a href="socialIdentity/cook/editSocialIdentity.do">
