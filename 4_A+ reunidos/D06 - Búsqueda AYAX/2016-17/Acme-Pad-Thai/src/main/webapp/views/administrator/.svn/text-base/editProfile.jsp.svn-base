...
<form:form action = "administrator/editProfile.do" modelAttribute = "administrator">
	...
	<legend>
		<spring:message code="administrator.informationData" />
	</legend>
		...
		<form:input path = "email"/><spring:message code = "administrator.email.help" />:
	...
	<jstl:choose>
		<jstl:when test="${administrator.socialIdentity == null}">
			<a href="socialIdentity/administrator/editSocialIdentity.do">
		...
		<jstl:when test="${administrator.socialIdentity != null}">
			...
			<legend>
				<spring:message code="administrator.socialIdentity" />
			</legend>
