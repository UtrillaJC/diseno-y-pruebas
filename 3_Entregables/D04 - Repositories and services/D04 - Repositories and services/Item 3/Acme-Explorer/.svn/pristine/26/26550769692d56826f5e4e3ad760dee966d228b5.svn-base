...
public class FinderServiceTest extends AbstractTest {
	...
	public void testSave() {
		...
		final Money priceMin = new Money();
		final Money priceMax = new Money();
		priceMin.setAmount(50.00);
		priceMin.setCurrency("€");
		priceMax.setAmount(100.00);
		priceMax.setCurrency("€");
	...
	public void testDelete() {
		...
		Finder finder, finderRetrieved;

		final Collection<Explorer> explorers = this.explorerService.findAll();
		final Explorer explorer = explorers.iterator().next();
	...
	public void testFindByPrincipal() {
		...
		super.authenticate("explorer1");
		finder = this.finderService.findByPrincipal();
		this.finderService.checkPrincipal(finder);
		super.authenticate(null);
	}
