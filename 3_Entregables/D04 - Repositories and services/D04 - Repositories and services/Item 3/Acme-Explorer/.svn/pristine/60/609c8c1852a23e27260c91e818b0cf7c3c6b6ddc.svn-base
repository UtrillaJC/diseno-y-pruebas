...
public class StoryServiceTest extends AbstractTest {
	...
	public void testCreate() {
		...
		trip = this.tripService.findOne(tripService.findAll().iterator().next().getId());							// Obtenemos el trip autenticado de la base de datos
	...
	public void testSave() {
		...
		trip = this.tripService.findOne(tripService.findAll().iterator()// Obtenemos el trip autenticado de la base de datos
				.next().getId());							             
	...
	public void testDelete() {
		...
		trip = this.tripService.findOne(tripService.findAll().iterator()// Obtenemos el trip autenticado de la base de datos
				.next().getId());							// Obtenemos el trip autenticado de la base de datos
		story = this.storyService.create(trip);							// Creamos trip utilizando el servicio
		writer = this.explorerService.findByPrincipal();				// Obtenemos el explorer autenticado de la base de datos
	...
	public void testAssignStoryToTrip() {
		...
		att.add("http://www.attachmentModified.com");
