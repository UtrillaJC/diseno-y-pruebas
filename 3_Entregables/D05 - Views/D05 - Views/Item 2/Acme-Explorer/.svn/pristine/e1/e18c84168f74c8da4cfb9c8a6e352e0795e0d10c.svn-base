...
<form:form action="${actionURI}" modelAttribute="sponsor">
	...
	<form:label path="address"><spring:message code="sposnor.address"/></form:label>
	<form:input path="address"/>
	<form:errors path="address" cssClass="error"/>
	<br/>
	
	<form:label path="phone"><spring:message code="sponsor.phone"/></form:label>
	<form:input path="phone"/>
	<form:errors path="phone" cssClass="error"/>
	<br/>
	
	<form:label path="username"><spring:message code="sponsor.username"/></form:label>
	<form:input path="username"/>
	<form:errors path="username" cssClass="error"/>
	<br/>
	
	<form:label path="password"><spring:message code="sponsor.password"/></form:label>
