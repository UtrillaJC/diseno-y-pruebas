...
public class PersonalRecordServiceTest extends AbstractTest {
	...
	public void TestSave() {
		...
		saved = this.personalRecordService.save(personalRecord, ranger1.getCurriculum());

		Assert.isTrue(this.curriculumService.findByRangerId(ranger1.getId()).getPersonalRecord().equals(saved));
	...
	public void TestDelete() {
		...
		this.personalRecordService.delete(saved, ranger1.getCurriculum());
