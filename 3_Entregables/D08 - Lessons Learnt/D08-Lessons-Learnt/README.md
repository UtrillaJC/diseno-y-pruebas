...
In this deliverable, we have done the A+ level. In this level, the connections are secure so, you need to configure the Tomcat Server as told in the Item 6 report.
If you don't configure it, you won't be able to run the project because it will ask for a secure connection.